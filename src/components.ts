...
export { default as RConfirm } from './confirm/index.vue'
export { default as RConfirmProvider } from './confirm/confirm-provider.vue'
...
export { default as RForm } from './form/index.vue'
export { default as RFormItem } from './form/form-item.vue'
...
export { default as RKeyboard } from './keyboard/index.vue'
...
export { default as RLoading } from './loading/index.vue'
export { default as RMark } from './mark/index.vue'
export { default as RPicture } from './picture/index.vue'
export { default as RPopover } from './popover/index.vue'
export { default as RProgress } from './progress/index.vue'
export { default as RQRCode } from './qr-code/index.vue'
export { default as RRate } from './rate/index.vue'
export { default as RSelect } from './select/index.vue'
export { default as RScope } from './scope'
export { default as RSlider } from './slider/index.vue'
export { default as RSpace } from './space/index.vue'
export { default as RSwitch } from './switch/index.vue'
export { default as RTabItem } from './tabs/tab-item.vue'
export { default as RTable } from './table/index.vue'
export { default as RTableColumn } from './table/table-column.vue'
